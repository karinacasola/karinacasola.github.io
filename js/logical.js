...
createApp({
    setup() {
        ...
        // --- Banco de Questões (40 Questões - Laços e Estruturas) ---
        const questions = ref([
            {
                id: 1,
            ...
            {
                id: 31,
                instruction: "Estruturas de Decisão (IF) e Condições Compostas.",
                scenario: "Em um diagrama no Flowgorithm, um aluno quer testar se o número 'x' está estritamente entre 10 e 20 (incluindo ambos).",
                text: "Qual a expressão lógica correta a ser digitada dentro do bloco If?",
                options: [
                    "x >= 10 and x <= 20",
                    "x >= 10 || x <= 20",
                    "10 < x < 20",
            ...
            {
                id: 32,
                instruction: "Dinâmica do Laço While.",
                scenario: "Um algoritmo deve repetir a leitura de uma senha enquanto ela for 'invalida'.",
                text: "O que acontece se a variável 'senha' for inicializada como 'valida' antes de chegar no bloco While?",
                options: [
                    "O laço pede a senha uma vez por segurança.",
                    "O laço nunca é executado e o fluxo avança livremente.",
                    "O laço entra em loop infinito.",
                    "O Flowgorithm acusa um erro lógico de compilação."
                ],
                answer: "O laço nunca é executado e o fluxo avança livremente."
            },
            {
                id: 33,
                instruction: "O Comportamento do DO (Faça).",
                scenario: "No Flowgorithm, a estrutura 'Do' (Fazer) executa primeiro o seu conteúdo e depois testa a condição.",
                text: "Se a condição lá no final for avaliada como Verdadeira, qual será o próximo passo do fluxo?",
                options: [
                    "Encerra a execução do algoritmo.",
                    "Ele segue diretamente para a próxima instrução isolada.",
                    "O fluxo retorna para o início do próprio bloco Do (Faça).",
                    "O laço inverte a lógica do teste para Falso."
                ],
                answer: "O fluxo retorna para o início do próprio bloco Do (Faça)."
            },
            {
                id: 34,
                instruction: "Decisões Avançadas.",
                scenario: "Muitas vezes, uma única condição não é suficiente. Um bloco 'If' (Se) é colocado dentro do ramo Falso de outro bloco 'If'.",
                text: "Esse padrão visual é um exemplo claro de qual conceito?",
                options: [
                    "Bifurcação paralela assíncrona.",
                    "Laço de repetição pré-testado.",
                    "Loop condicional infinito.",
                    "Estrutura condicional aninhada ou encadeada."
                ],
                answer: "Estrutura condicional aninhada ou encadeada."
            },
            {
                id: 35,
                instruction: "Precedência de Operadores Lógicos.",
                scenario: "Expressões complexas podem utilizar múltiplos operadores na mesma linha.",
                text: "Ao utilizar operadores lógicos no Flowgorithm sem o uso de parênteses, qual é a ordem de prioridade de resolução?",
                options: [
                    "NOT, AND, OR.",
                    "AND, OR, NOT.",
                    "OR, AND, NOT.",
                    "Não há prioridade, o computador lê da esquerda para a direita."
                ],
                answer: "NOT, AND, OR."
            },
            {
                id: 36,
                instruction: "Visualizando Rotas do Laço FOR.",
                scenario: "Ao declarar o bloco For no Flowgorithm, o fluxo do hexágono divide-se visualmente para as setas 'Next' (Próximo) e 'Done' (Concluído).",
                text: "O que desencadeia a rota que leva até 'Done'?",
                options: [
                    "Um operador AND retornar um valor falso.",
                    "O contador atingir o limite estipulado no Valor Final e o laço terminar.",
                    "A variável de controle ser declarada como nula.",
                    "O usuário forçar a saída apertando o botão 'Parar'."
                ],
                answer: "O contador atingir o limite estipulado no Valor Final e o laço terminar."
            },
            {
                id: 37,
                instruction: "Operadores Relacionais e Lógica.",
                scenario: "Para tomar decisões lógicas (Verdadeiro ou Falso), as variáveis são submetidas a testes relacionais.",
                text: "No Flowgorithm, o símbolo '!=' ou a notação 'not =' são utilizados para representar qual operação?",
                options: [
                    "Atribuição contínua de valores.",
                    "Maior ou igual.",
                    "Diferença (Não igual).",
                    "Negação lógica exclusiva (XOR)."
                ],
                answer: "Diferença (Não igual)."
            },
            {
                id: 38,
                instruction: "Combinando IF com Operadores (Cenário de Vendas).",
                scenario: "Uma loja concede um desconto se o cliente comprar mais de 5 itens OU se o valor total for acima de R$ 100.",
                text: "Como fica corretamente declarada essa condição no bloco IF?",
                options: [
                    "itens > 5 and valor > 100",
                    "itens >= 5 or valor >= 100",
                    "itens > 5 && valor > 100",
                    "itens > 5 or valor > 100"
                ],
                answer: "itens > 5 or valor > 100"
            },
            {
                id: 39,
                instruction: "Configurando Laços FOR (Step).",
                scenario: "Um estudante precisa que o Flowgorithm mostre os números pares de 2 a 10. Ele usa um laço FOR inicializado em 2 e finalizando em 10.",
                text: "Qual deve ser o valor do 'Passo' (Step) configurado para exibir apenas os números pares?",
                options: [
                    "Passo (Step) 2.",
                    "Passo (Step) 0.",
                    "Passo (Step) 1.",
            ...
            {
                id: 40,
                instruction: "Avaliação Lógica Prática.",
                scenario: "Um algoritmo possui duas variáveis, onde X = 5 e Y = 10.",
                text: "Qual será o resultado lógico (True/False) avaliado na expressão: (X < 10) AND (Y != 10)?",
                options: [
                    "Verdadeiro (ambas as condições são satisfeitas).",
                    "Falso (pois a condição de Y falha ao não ser diferente de 10).",
                    "Nulo (as variáveis são de tipos incompatíveis).",
                    "Erro de sintaxe (faltam operadores textuais)."
                ],
                answer: "Falso (pois a condição de Y falha ao não ser diferente de 10)."
            }
        ]);
        ...
        const saveResultPDF = () => {
            ...
            if (score.value < 28) performanceMsg = "Recomenda-se revisão aprofundada das portas lógicas e estruturas do Flowgorithm."; // Ajustado para ser mais proporcional às 40 perguntas
            ...
            printElement.innerHTML = `
                ...
                <div style="margin-bottom: 30px; font-size: 16px; line-height: 1.6; text-align: justify;">
                    ...
                    <div style="background-color: #f4f7f6; padding: 20px; border-radius: 8px; margin-top: 30px; text-align: center; border: 1px solid #e0e0e0;">
                        ...
                        <p style="font-size: 28px; color: ${score.value >= 32 ? '#10B981' : (score.value >= 20 ? '#d9a05b' : '#EF4444')}; margin: 15px 0;">
