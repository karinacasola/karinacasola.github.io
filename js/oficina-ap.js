...
const courseData = {
    0: {
        title:"Protocolo Pyfirmata2",
        desc: "Arduino Uno com Python",
        slides: [
            "latex/aula0/1.jpg", 
            "latex/aula0/2.jpg",
            "latex/aula0/3.jpg",
        ...
        pdfFile: "latex/aula0/Oficina___Introdução.pdf"
    },
    1: {
        title: "Etapa 1: Introdução",
        desc: "Compreendendo aspectos e cases de utilização do Protocolo",
        slides: ["latex/aula0/1.jpg"],
        pdfFile: "latex/aula0/Parte_1___Oficina_Arduino_com_Python__Pyfirmata2.pdf"
    },
    2: {
        title: "Etapa 2: Configuração",
        desc: "Preparando Hardware (Arduino) e Software para integração Python via Firmware Firmata.",
        slides: ["latex/aula0/1.jpg"],
        pdfFile: "latex/aula0/Parte_2___Oficina_Arduino_com_Python__Configuração_Pyfirmata2.pdf"
    },
    3: {
        title: "Etapa 3: Projetos Práticos",
        desc: "Pratica com Arduino Uno R3 e o Protocolo Pyfirmata2",
        slides: ["latex/aula0/1.jpg"],
        pdfFile: "latex/aula0/Parte_3___Projetos.pdf"
    }
};
...
window.abrirApresentacao = function(id) {
    ...
    if (btnPraticar) {
        switch(id) {
            case 1:
                btnPraticar.href = 'oficina-forca.html';
                btnPraticar.style.display = 'inline-block';
                break;
            case 2:
                btnPraticar.href = 'oficina-pyfirmata2.html';
                btnPraticar.style.display = 'inline-block';
                break;
            case 3:
                btnPraticar.href = 'oficina-quizz.html';
                btnPraticar.style.display = 'inline-block';
                break;
            case 0:
            default:
                btnPraticar.href = 'https://docs.arduino.cc/hardware/uno-rev3/'; 
                break;
        }
    }
...
async function carregarE_RenderizarPdf(url) {
    ...
    try {
        ...
        for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
            ...
            // ------------------------------------------------------------------
            // QUALIDADE: escala de 1.5 para 3.0 (ou mais)
        ...
        // PLANO B: Iframe
        container.innerHTML = `
            <div style="background-color: #1259f381; color: #fff; padding: 8px; font-size: 12px; text-align: center; width: 100%;">
                           </div>
